export const editor = {
  ...
  format_plain:           "Text",
  format_switch_confirm:  "Changing the content type will not convert what you have written — the same text will be interpreted differently. Continue?",
  format_php_unsupported: "This page is PHP and can only be viewed in the classic interface.",
  ...
  media:            "Image, video, audio or YouTube/Vimeo link",
  media_url:        "Media URL",
  table:            "Table",
  table_columns:    "Columns",
  table_rows:       "Rows",
  spoiler:          "Spoiler",
  spoiler_label:    "Label (optional)",
  quote_author:     "Author (optional)",
  url_label:        "URL",
  insert:           "Insert",
  ...
  poster_btn: "Poster",
  poster_title: "Choose poster frame",
  poster_hint: "Scrub to the frame you want, then use it as the video poster.",
  poster_use_frame: "Use this frame",
  poster_error: "Could not set poster",
  cam_edit:         "Edit",
