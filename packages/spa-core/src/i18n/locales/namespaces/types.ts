...
export type RawDictionary = {
  ...
  tour: {
    ...
    dm_label:               string;
    dm_desc:                string;
    dm_inbox_title:         string;
    dm_inbox_text:          string;
    dm_button_title:        string;
    dm_button_text:         string;
    dm_recipient_title:     string;
    dm_recipient_text:      string;
    dm_quick_title:         string;
    ...
    ui_nav_title:           string;
    ui_nav_text:            string;
    ui_bottom_title:        string;
    ui_bottom_text:         string;
    ui_user_menu_title:     string;
    ui_user_menu_text:      string;
    ui_content_title:       string;
    ui_content_text:        string;
    ui_sidebar_title:       string;
    ui_sidebar_text:        string;
    ui_edit_layout_title:   string;
    ui_edit_layout_text:    string;
  };
  help: {
  ...
  post: {
    ...
    loading_comments: string; load_more_comments: string; expand_collapsed: string; viewing_in_context: string; show_all_comments: string; fetch_more_replies: string; fetch_more_replies_hint: string; fetch_replies_loading: string; fetch_replies_none: string; fetch_replies_done: string; loading: string; loading_source: string;
  ...
  hq: {
    ...
    op_tag_hint:           string;
    op_after:              string;
    op_after_hint:         string;
    op_before:             string;
    op_before_hint:        string;
    search_tags:           string;
    operators:             string;
    date_range:            string;
    date_from:             string;
    ...
    emptied_trash:         string;
    emptying:              string;
    search_placeholder:    string;
    search_operators:      string;
    clear_search:          string;
    filter_attachment:     string;
    filter_mentioned:      string;
    back_to_list:          string;
  ...
  share: {
    ...
    scope_site:            string;
    scope_connections:     string;
    scope_contacts:        string;
    scope_specific:        string;
    embed_bbcode:         string;
