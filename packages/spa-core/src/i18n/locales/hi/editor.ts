...
export const editor: RawDictionary["editor"] = {
  ...
  format:                 "सामग्री प्रकार",
  format_bbcode:          "BBcode",
  format_html:            "HTML",
  format_markdown:        "Markdown",
  format_plain:           "सादा पाठ",
  format_switch_confirm:  "सामग्री प्रकार बदलने से आपका लिखा हुआ रूपांतरित नहीं होगा — वही पाठ अलग तरह से पढ़ा जाएगा। जारी रखें?",
  format_php_unsupported: "यह पृष्ठ PHP है और केवल क्लासिक इंटरफ़ेस में ही देखा जा सकता है।",
  language_label:         "भाषा",
  ...
  spoiler:          "स्पॉइलर",
  spoiler_label:    "लेबल (वैकल्पिक)",
  quote_author:     "लेखक (वैकल्पिक)",
  url_label:        "URL",
  ...
  poster_btn: "पोस्टर",
  poster_title: "पोस्टर फ़्रेम चुनें",
  poster_hint: "मनचाहे फ़्रेम पर जाएँ, फिर उसे वीडियो पोस्टर बनाएँ।",
  poster_use_frame: "यह फ़्रेम इस्तेमाल करें",
  poster_error: "पोस्टर सेट नहीं हो सका",
