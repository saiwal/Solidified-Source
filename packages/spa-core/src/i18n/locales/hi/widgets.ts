...
export const widgets: RawDictionary["widgets"] = {
  ...
  style_list:     "सूची",
  style_cloud:    "क्लाउड",
  style_calendar: "कैलेंडर",
  rainbow_mode:   "इंद्रधनुषी रंग",
  connections:    "कनेक्शन",
  view_all:       "सभी देखें",
  ...
  channel_feed_chronological: "फ़ीड (कालक्रमानुसार)",
  channel_feed_masonry: "फ़ीड (ग्रिड)",
  channel_feed_list: "फ़ीड (सूची)",
